...
This isn't just a smoke test — Docling's page-number metadata has
documented edge cases for chunks spanning multiple pages, so this spot-
checks real output rather than assuming correctness. If this ever starts
failing after a docling upgrade, treat it as a real signal, not a flaky
test.
"""
